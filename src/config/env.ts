...
const envSchema = z.object({
  ...
  TAXI_BASE_FARE_USD: z.coerce.number().nonnegative().default(25),
  TAXI_PER_KM_USD: z.coerce.number().nonnegative().default(0),
  TAXI_MINIMUM_FARE_USD: z.coerce.number().nonnegative().default(25),
